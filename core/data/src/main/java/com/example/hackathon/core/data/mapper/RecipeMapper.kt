...
fun RecipeDetailResponse.toDomain(): RecipeDetail = RecipeDetail(
    id = id,
    title = title,
    category = category,
...
fun RecipeRankingResponse.toDomain(): RecipeRanking = RecipeRanking(
    currentCategory = currentCategory,
    list = list.map { it.toDomain() }
)

fun RecipeRankingItemResponse.toDomain(): RecipeRankingItem = RecipeRankingItem(
    title = title,
    description = description,
    viewCount = viewCount,
    likes = likes,
 ...
 */
fun PostPreviewDto.toDomain(): RecipeRankingItem = RecipeRankingItem(
    title = title,
    description = description ?: "",
    viewCount = viewCount,
    likes = likesCount,
 ...
 */
fun List<PostPreviewDto>.toDomain(currentCategory: String = "ALL"): RecipeRanking = RecipeRanking(
    currentCategory = currentCategory,
 ...
 */
fun DetailResponse.toDomain(): RecipeDetail = RecipeDetail(
    id = postId,
    title = title,
    category = category ?: "",
    description = description,
