...
import com.example.hackathon.core.network.dto.response.BaseResponse
...
interface CombinationService {
    ...
    @GET("combinations/{id}")
    suspend fun getCombinationById(@Path("id") id: String): BaseResponse<CombinationResponse>
    ...
    suspend fun deleteCombination(@Path("id") id: String): BaseResponse<Unit>

    @GET("users/me/combinations")
    suspend fun getMyCombinations(): BaseResponse<List<CombinationResponse>>

    @POST("combinations/{id}/like")
    suspend fun likeCombination(@Path("id") id: String): BaseResponse<Unit>
